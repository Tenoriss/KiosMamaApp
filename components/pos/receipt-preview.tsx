...
export function ReceiptPreview({ sale, storeName, storeAddress, storePhone, receiptHeader, receiptFooter, onClose }: ReceiptPreviewProps) {
  const printReceipt = () => {
    ...
    printWindow.document.write(`<!doctype html><html><head><title>${escapeHtml(sale.invoiceNumber)}</title><style>
      *{box-sizing:border-box}body{margin:0;background:#f3f1eb;color:#24312e;font-family:Arial,sans-serif}.receipt{width:80mm;margin:18px auto;padding:24px 18px;background:#fffdf8;box-shadow:0 8px 28px #173f3a1c}.brand{text-align:center;border-bottom:1px dashed #a7b5ae;padding-bottom:16px}.mark{width:46px;height:46px;object-fit:contain;border-radius:10px;margin-bottom:8px}.brand h1{margin:0;font-size:19px;letter-spacing:.04em}.brand p{margin:5px 0 0;color:#65736d;font-size:10px;line-height:1.5}.meta{display:flex;justify-content:space-between;gap:10px;margin:14px 0;color:#65736d;font-size:10px}.items{border-top:1px solid #d8dfda;border-bottom:1px solid #d8dfda;padding:10px 0}.item{display:flex;justify-content:space-between;gap:12px;margin:8px 0;font-size:11px}.item div{min-width:0}.item strong{font-size:11px}.item small{display:block;color:#76847e;font-size:10px;margin-top:3px}.summary{padding-top:10px;font-size:11px}.row{display:flex;justify-content:space-between;margin:7px 0;color:#65736d}.total{border-top:1px solid #173f3a;margin-top:10px;padding-top:10px;color:#173f3a;font-size:15px;font-weight:bold}.paid{margin-top:10px;padding-top:8px;border-top:1px dashed #a7b5ae}.thanks{text-align:center;margin-top:18px;padding-top:13px;border-top:1px dashed #a7b5ae;color:#173f3a;font-size:11px;line-height:1.6}@media print{body{background:#fff}.receipt{width:80mm;margin:0;box-shadow:none}}
