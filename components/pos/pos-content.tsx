    ...
    <div className="grid gap-5 xl:grid-cols-[1.25fr_0.75fr]">
      ...
      <Card className="h-fit xl:sticky xl:top-24">
        ...
        <CardContent className="space-y-4">
          ...
          <div className="grid gap-3 sm:grid-cols-2 xl:grid-cols-1"><Input label="Pelanggan (opsional)" value={customerName} onChange={e => setCustomerName(e.target.value)} placeholder="Nama pelanggan" /><Select label="Metode pembayaran" value={paymentMethod} onChange={e => setPaymentMethod(e.target.value as PaymentMethod)} options={[{ value: 'CASH', label: 'Tunai' }, { value: 'QRIS', label: 'QRIS' }, { value: 'BANK_TRANSFER', label: 'Transfer Bank' }, { value: 'CREDIT', label: 'Hutang / Kredit' }]} /><NumberInput label="Diskon (MYR)" min="0" allowDecimal value={discount} onValueChange={setDiscount} /><NumberInput label="Bayar (MYR)" min="0" allowDecimal value={payment} onValueChange={setPayment} /></div>
